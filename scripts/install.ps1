...
$entries = @(".ai", "openspec", "knowledge", "scripts/verify-workflow-artifacts.mjs", "scripts/runtime-governance.mjs", "scripts/run-verified-command.mjs", "scripts/archive-openspec-change.mjs")
if ($WithDocs) {
    $entries += "docs"
}
