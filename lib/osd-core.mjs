...
const SENSITIVE_VALUE_PATTERNS = [
  ...
  { name: "openai_stripe_key", pattern: /\bsk-[A-Za-z0-9]{20,}\b/ },
  ...
  { name: "generic_api_key", pattern: /\b[A-Za-z0-9+/]{32,}={0,2}\b/ },
];
...
export function parseArgs(argv) {
  ...
  const commands = new Set(["init", "doctor", "adapters", "start", "approve", "plan", "implement", "verify", "review", "archive", "status", "context", "authorize", "event", "evaluate", "summarize", "config", "upgrade", "rollback"]);
